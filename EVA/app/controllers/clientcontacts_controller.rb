class ClientcontactsController < ApplicationController
  ...
  def create
    @clientcontact = Clientcontact.new(clientcontact_params)
     if current_user.company_id
         @clientcontact.company_id = current_user.company_id
       end
  ...
  private
   ...
   params.require(:clientcontact).permit(:names,:lastnames,:note,:hiredate,:movil, :tel, :mail, :active, :company_id,:customer_id,:warehouse_id)
    end
end
